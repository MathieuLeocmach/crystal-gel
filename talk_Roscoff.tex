...
\begin{frame}{Gel formation}
	\begin{columns}
		...
		\end{itemize}
		\begin{tikzpicture}
	\draw[->] (0,0) -- +(\textwidth,0) node[pos=0.1, label=-90:\textcolor{ilmorange}{$\tau_1$}](t1) {|} node[pos=0.5, label=-90:\textcolor{ilmcolor}{$\tau_2$}] (t2){|};
	\fill[ilmcolor] ($(t1)!0.1!45:(t2)$) coordinate(cse) rectangle ($(t1)!0.9!45:(t2)$) coordinate(cnw);
	\clip (cse) rectangle (cnw);
	\fill[ilmorange] ++($(cse)!0.5!(cnw)$) 
		+(60:0.06\textwidth) circle (0.045\textwidth) 
		+(180:0.06\textwidth) circle (0.045\textwidth) 
		+(-60:0.06\textwidth) circle (0.045\textwidth) 
		+(0:0.12\textwidth) circle (0.045\textwidth)
		+(120:0.12\textwidth) circle (0.045\textwidth)
		+(-120:0.12\textwidth) circle (0.045\textwidth)
		+(45:0.16\textwidth) circle (0.045\textwidth)
		+(-45:0.16\textwidth) circle (0.045\textwidth);
	\end{tikzpicture}
	\end{columns}
\end{frame}
