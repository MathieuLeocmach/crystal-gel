...
In Fig.~\ref{fig:phase_separation}A, we superimpose the state points with the phase diagram calculated from generalised free volume theory~\cite{Fleer2008}.
...
at $\phi\approx 0.30$ and $c_p=0.38$ mg/g reaches close packing at a volume fraction of around $\sim 60\%$, which is in reasonable agreement with the
