...
At $t=0$, the increase in the concentration of salt ions \textcolor{blue}{within a few Brownian times ($\tau_B$)} screens the Coulombic repulsion between colloidal particles,
...
(\textcolor{red}{we don't imply that the formation of the network follows the random gelation universality class, just that our
...
is arrested by crystallization and not by glassiness. Although our estimation of the absolute volume fraction may involves \textcolor{blue}{systematic errors of a few \%, the trend should be robust~\cite{Poon2012}}.
...
\textcolor{red}{a fractal dimension close to random percolation ($D=2.53$)}, while at large sizes it scales as $D=3$, \textcolor{red}{as in} compact crystal growth. This demonstrates that, while 
...
is then accompanied by an increase in the fraction of gas particles: as the first crystals start to \textcolor{blue}{reach} the gas phase, liquid particles evaporate 
...
\textcolor{red}{We speculate that our scenario could play a role in the formation of crystal networks observed in dynamically asymmetric mixtures, 
