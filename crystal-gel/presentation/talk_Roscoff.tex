...
\begin{frame}{Crystallisation}
	...
	\input{fig_presentation/whyx.pgf}
...
\begin{groupplot}[%
	...
	\addplot table[x expr={\thisrowno{0}/2.3e3}]{/data/Documents/tex/svn/crystal-gel/data/fig3a_1.dat} node[left] at (rel axis cs:1,0.2) {avg size};
	\addplot table[x expr={\thisrowno{0}/2.3e3}]{/data/Documents/tex/svn/crystal-gel/data/fig3a_2.dat} node[left] at (rel axis cs:1,0.6) {number};
	...
	\addplot[only marks, red, thick, mark=*] file{/data/Documents/tex/svn/crystal-gel/data/fig3d_sqrt_1.dat};
...
\end{tikzpicture}
\begin{center}
\tikzsetnextfilename{pathsX}\vspace{-0.5em}\input{pathsX.pgf}
\end{center}
\end{frame}

\begin{frame}{Dynamics: Bergeron > Ostwald}
\vspace{\baselineskip}
\includegraphics[width=\textwidth]{/data/Documents/tex/svn/crystal-gel/nature/fig4.pdf}
\end{frame}
