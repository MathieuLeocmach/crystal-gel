...
%\documentclass[aps,prl,twocolumn,showpacs,amsmath,amssymb,superscriptaddress]{revtex4}
%\documentclass[a4paper,showpacs,aps,twocolumn,superscriptaddress]{revtex4}
\documentclass[a4paper,preprint,superscriptaddress]{revtex4}
...
\begin{figure}[!t]
 ...
 % csd_beforegrl.eps: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=(atend)
...
\begin{figure}[!t]
 ...
 % figure_restructuring.eps: 990x765 pixel, 300dpi, 8.38x6.48 cm, bb=0 -1 1453 480
...
\begin{figure}[!t]
 \centering
 \includegraphics[width=16cm]{fig4a}
 \includegraphics[width=8cm]{fig4b}
 \includegraphics[width=8cm]{fig4c}
