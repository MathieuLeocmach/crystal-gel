...
\begin{frame}{Gel formation}
	\begin{columns}
		...
		\nextgroupplot[
			...
			\addplot[black, no marks] file {res_gasliquid_bl.phd} node[pos=0.5,sloped,below] {liquid};
			\addplot[black, no marks] file {res_gasliquid_bg.phd} node[pos=0.1,sloped,below] {gas};
...
\begin{frame}{Crystals outgrow metastable liquid}
	...
	\hfill\includegraphics[width=0.95\textwidth, clip=true, trim=0 20cm 0 0]{nature/fig4.pdf}\hfill
\end{frame}
