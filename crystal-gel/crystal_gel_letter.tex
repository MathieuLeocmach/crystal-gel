...
\begin{abstract}
{
With confocal measurements of a PMMA colloid and polymer mixture, we experimentally access the formation of a novel arrested state,
formed by crystal droplets nucleating inside the dense branches of a gel, and growing by direct condensation of the gas phase on the surface of the crystals.
% in which the dense branches of a gel are replaced by crystal aggregates~\cite{fortini2008crystallization,perez2011pathways,sabin2012}, which then grow into droplets by direct condensation of the gas phase on the surface of the crystals.
We call this new state \emph{colloidal rain}, as it represents the colloidal analogue of rain formation from ice crystals that occurs in mixed phase clouds (the Bergeron process)~\cite{glickman2000glossary}.
We observe the dynamics of the system at single-particle level, giving for the first time full experimental access to the kinetic
pathway of droplet formation. The formation of colloidal rain occurs at low polymer concentrations, close to the metastable critical point~\cite{ten1997enhancement}, where
the strength of the interparticle attractions is low enough to allow bond reorganization and nucleation. For high polymer concentrations, instead, the system
forms colloidal gels~\cite{lu2008gelation}, 
where viscoelastic phase separation is interrupted by the glass transition.
We thus argue that states similar to colloidal rain can form as the result of the gas-liquid phase separation of crystallizable components, such as monoatomic and molecular systems, whose dynamics is slow enough to induce viscoelastic phase separation, but fast enough to prevent immediate vitrification.
}
\end{abstract}
...
\begin{figure*}[!t]
 ...
 % fig1b.pdf: 687x479 pixel, 72dpi, 24.24x16.90 cm, bb=0 0 687 479
