...
\textcolor{blue}{
With confocal microscopy measurements we access the microscopic mechanism of crystal growth in a three phase system of a colloid-polymer mixture
undergoing viscoelastic phase separation.} We show that crystallization leads to a network structure different from the original phase separation pattern. Crystals nucleate inside the liquid network, and grow past it by direct condensation of the gas phase on their surface, driving evaporation of nearby liquid. This process represents the colloidal analogue of the Bergeron process, i.e., ice crystals formation that occurs in mixed phase clouds and is at the origin of rain. Our \emph{colloidal rain} gives us full experimental access to the kinetic pathway of this phenomenon important for climate science. We argue that states similar to colloidal rain can form as the result of the gas-liquid phase separation of crystallizable components, such as monoatomic and molecular systems, whose dynamics is slow enough to induce viscoelastic phase separation, but fast enough to prevent immediate vitrification.
\end{sciabstract}
...
\textcolor{blue}{Crystallization plays a fundamental role in many processes occurring in nature, such as cloud composition, and in technologial applications
that are at the core of the chemical, pharmaceutical and food industries.
Many of the properties of crystals, like the polymorph type and size distribution of the crystallites, depend on the conditions at which
...
\textcolor{blue}{Under usual conditions, the nucleation stage involves a very small number of molecules, of the order of 10-1000 molecules.
This has severily limited the possibility to observe the nucleation process directly, and has also posed limits on
...
Classical Nucleation Theory assumes the crystallization processes to occurr in one step,
...
directly from the supersatured solution. But the possibility of different pathways has recently come to prominence with
the discovery of two-step nucleation pathways, where crystallization is preceeded by the formation of dense liquid droplets~\cite{ten1997enhancement,SearR,savage2009experimental,vekilov2010two,palberg2014crystallization}.
...
\textcolor{blue}{Colloidal solutions offer a system where the crystallization process in a mixed-phase environment can be observed with single particle
...
During phase separation, the density of the liquid phase 
...
In our colloidal system, we then call this process ``colloidal rain''
formation.
\textcolor{blue}{\sout{Due to the difference in the nucleation and growth processes, the droplets display different scaling laws depending on their
...
The experimental data is taken at two different volume fractions ($\phi\approx 0.13$ and $\phi\approx 0.30$) and for different values
of the polymer concentration, $c_p=0.38,0.48,0.57,1.07$ mg/g for $\phi\approx 0.30$ and $c_p=0.82,1.36$ mg/g for $\phi\approx 0.13$.
In Fig.~\ref{fig:phase_separation}A, we superimpose the state points with the phase diagram \textcolor{blue}{which we calculated from generalised free volume theory~\cite{Fleer2008} using the experimental values for the size of the colloids, the radius of gyration of the polymer and the polymer concentration (see Supplementary Information)}.
For each state points, scans at early times (every $10$~s, i.e. $4\tau_B$) and at the late stage (every $30$~s) of the gelation process. 
...
% at the state points of $\phi\approx 0.13$. We observe that at high polymer concentration ($c_p=1.36$, dashed lines) both the
...
% undergoing network reorganization $\phi\approx 0.13$ and $c_p=0.82$. The time of network reorganization as found in Fig.~\ref{fig:stress}a and b
...
% 
% The same conclusions also hold for the state point at $\phi\approx 0.30$. We observe network restructuring only for the state point
...
\textcolor{blue}{In Fig.~\ref{fig:phase_separation}A, the state points which didn't phase separate are indicated with open triangles, while
the other symbols indicate samples undergoing phase separation. The (black) continous line is the gas spinodal computed from free volume theory,
...
But a difference
in the fractal dimension $D$ between the $\phi\approx 0.30$ and $c_p=0.38$ mg/g state point and other state points starts to become visible. In fact, while states
...
at $\phi\approx 0.30$ and $c_p=0.38$ mg/g reaches \textcolor{blue}{close packing at a volume fraction of around $\sim 68\%$, which is in reasonable agreement with the
volume fraction of the stable crystal phase~\cite{ilett1995phase}. All other state points, instead, reach close packing at volume fraction $\sim 64\%$, which is
...
To confirm the formation of crystalline seeds we adopt bond orientational analysis to detect which particles are in crystalline environments~\cite{russo2013interplay}. With this analysis we confirm that crystallization events start occurring for the state point $\phi\approx 0.30$ and $c_p=0.38$ mg/g, which has the lowest
...
\textcolor{blue}{evaporation of the liquid phase and subsequent direct condensation of the gas phase
on the crystalline seeds.}
To investigate this process, we plot in Fig.~\ref{fig:crystals}B the gyration radius of individual crystalline nuclei for the state point
...
From the trajectory, we extract slabs of 10 particle diameter thickness for configurations at $\phi\approx 0.30$ and $c_p=0.38$ mg/g at different times,
shown in Fig.~\ref{fig:transitions}A slabs.
...
%First we show in Fig.~\ref{fig:transitions}a slabs of 10 particle diameter thickness for configurations at $\phi\approx 0.30$ and $c_p=0.38$ at different times.
...
(i) Crystallization, observed at $\phi\approx 0.30$ and $c_p=0.38$ mg/g, small crystalline nuclei appear inside the liquid, reach the surface
...
be regarded as a colloidal analogue for this important process, \textcolor{blue}{which, for the first time, we can observe at the single-particle level.} 
...
of a network structure of the minority phase, and (iv) the degree of supercooling is low enough to avoid a high rate of densification of the liquid phase 
