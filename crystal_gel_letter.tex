...
For the first time we are able to observe the dynamics of the system at single-particle level, giving full experimental access to the entire kinetic
...
the strength of the interparticle attractions is low enough to allow bond reorganization and nucleation. For high polymer concentrations the system
forms colloidal gels~\cite{lu2008gelation}, 
where viscoelastic phase separation is interrupted by the glass transition.
We thus argue that similar states can form as the result of the gas-liquid phase separation of crystallizable components, such as monoatomic and molecular systems, whose dynamics is slow enough to induce viscoelastic phase separation, but fast enough to prevent immediate vitrification.
}
\end{abstract}
...
polymer concentration of all state points. This is shown in Fig.~\ref{fig:statepoints}a where the black line indicates the average size of the crystallites,
