...
\textbf{a,} Snapshots of configurations at $\phi=0.25$ and $c_p=0.38$. Particles are coloured according to their phase. Dark red: crystal; orange: surface of crystal; yellow: liquid; blue: gas. 
 \textbf{b,} Fraction of particles for each phase.
