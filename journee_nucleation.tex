...
\institute[iLM]{Equipe Liquides et Interfaces}%{Univ Lyon, Université Claude Bernard Lyon 1, CNRS, Institut Lumière Matière}
\title[crystal gel]{A novel route to the spontaneous formation of porous crystals via viscoelastic phase separation}
\author[M. Leocmach]{Mathieu Leocmach \hfill{\usebeamerfont{normal text}\texttt{\usebeamercolor[fg]{normal text}\footnotesize @LamSonLeoc\includegraphics[height=1em]{Twitter_Bird}}}\vspace{-0.5\baselineskip}}
\date{16 Nov 2016}
\titlegraphic{
...
\begin{frame}<1>[label=intro]{How does it crystallise?}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item<2> \structure{More detailed view of the processes needed}
	\end{itemize}
\end{frame}
...
\begin{frame}{Real space: crystal gel!}
	...
	\matrix[matrix of nodes, inner sep=0, above left= 0 and -\textwidth of ax.outer south west, row sep=0.5em, column sep=0.3em,ampersand replacement=\&] (m){
		...
		\includegraphics[width=\ml]{presentation/sliceILM_highcp_t800.jpg}\\
		\includegraphics[width=\ml]{presentation/lowcpfinal_gaussian.jpg}\&
		\includegraphics[width=\ml]{presentation/sliceILM_t890.jpg}\\
	};
	\matrix[
